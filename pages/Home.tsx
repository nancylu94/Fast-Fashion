  ...
  return (
    <div className="relative min-h-screen animate-in fade-in duration-500">
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-[85vh] flex items-center justify-center px-4 pt-20 pb-10">
          <div className="container mx-auto text-center max-w-4xl">
            <div className="inline-block mb-4 px-4 py-1 rounded-full border border-rose-400/30 bg-rose-500/20 backdrop-blur-md text-rose-200 font-bold tracking-widest text-xs uppercase shadow-sm">
              Fast Fashion Waste
            </div>
            ...
            <p className="text-xl md:text-2xl text-slate-100 max-w-2xl mx-auto mb-12 leading-relaxed font-medium drop-shadow-lg text-shadow">
              Every week, <strong>15 million</strong> used garments arrive in Accra. 
              <br className="hidden md:block" />
              40% of it ends up here: burying the beaches and choking the ocean.
            </p>
            <button
        ...
        {/* Info Cards - Glassmorphism Light */}
        <section className="py-20 bg-white/90 backdrop-blur-md px-4 shadow-2xl">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white/50 border border-slate-200 p-8 rounded-2xl hover:border-rose-200 hover:shadow-xl hover:bg-white transition-all duration-300 group backdrop-blur-sm">
        ...
        {/* Quote Section - Glassmorphism Dark */}
        <section className="py-24 bg-blue-900/85 backdrop-blur-md px-4 border-t border-blue-800/50 relative overflow-hidden">
          <div className="absolute top-0 left-0 w-64 h-64 bg-rose-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
          <div className="absolute bottom-0 right-0 w-64 h-64 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
          
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <blockquote className="text-3xl md:text-4xl font-serif italic text-white mb-8 leading-tight drop-shadow-md">
